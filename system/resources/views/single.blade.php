            ...
            <div class="container">
                <div class="col-md-8 showcase">
                    <div class="flexslider">
                          <ul class="slides">
                            <li data-thumb="{{url('public')}}/img/3.jpg">
                                <div class="thumb-image"> <img src="{{url('public')}}/img/23.jpg" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="{{url('public')}}/img/2.jpg">
                                 <div class="thumb-image"> <img src="{{url('public')}}/img/2.jpg" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="{{url('public')}}/img/3.jpg">
                               <div class="thumb-image"> <img src="{{url('public')}}/img/3.jpg" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="{{url('public')}}/img/6.jpg">
                               <div class="thumb-image"> <img src="{{url('public')}}/img/6.jpg" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                          </ul>
        ...
        <div class="you-might-like">
            <div class="container">
                ...
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    ...
                    <div class="img"><img src="{{url('public')}}/img/19.jpg" style="width: 300px;height: 300px;" class="img-responsive gri-wid"></div>
                            <div class="info">
                ...
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    <!-- normal -->
                        <div class="ih-item square effect3 bottom_to_top">
                            <div class="bottom-2-top">
                    <div class="img"><img src="{{url('public')}}/img/21.jpg" style="width: 300px;height: 300px;" class="img-responsive gri-wid"></div>
                            <div class="info">
                                <div class="pull-left styl-hdn">
                                    <h3>style 01</h3>
                                </div>
    ...
    <p><a  href="#" class="item_add"><span class="glyphicon glyphicon-shopping-cart grid-cart" aria-hidden="true"></span> <span class=" item_price">$190</span></a></p>
                ...
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    <!-- normal -->
                        <div class="ih-item square effect3 bottom_to_top">
                            <div class="bottom-2-top">
                    <div class="img"><img src="{{url('public')}}/img/16.jpg" style="width: 300px;height: 300px;" class="img-responsive gri-wid"></div>
                            <div class="info">
                                <div class="pull-left styl-hdn">
                                    <h3>style 01</h3>
                                </div>
